...
namespace vdrlive {
   ...
   */
  enum class eSortOrder { name, title, date, duration, errors, durationDeviation, duplicatesLanguage };
...
// scraper data
  ...
  class RecordingsItemRec
  {
    ...
    public:
      ...
      cSv FolderForSearch() const { return m_folder_for_search; }
